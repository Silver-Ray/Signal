...
void Init_AD9959(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = (0x4FFF << 0); // Initialize PD0~11 and PD14
...
void fre(uint8_t Channel, uint32_t Freq)
{
    Write_frequence(Channel, Freq);
}

void amp(uint8_t Channel, uint16_t Ampli)
{
    Write_Amplitude(Channel, Ampli);
}
void pha(uint8_t Channel, uint16_t Phase)
{
